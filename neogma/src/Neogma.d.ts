...
export declare class Neogma {
    ...
    getTransaction: <T>(runInTransaction: Runnable | null, callback: (tx: Transaction) => Promise<T>) => Promise<T>;
    getRunnable: <T>(runInExisting: Runnable | null, callback: (tx: Runnable) => Promise<T>) => Promise<T>;
}
export {};
